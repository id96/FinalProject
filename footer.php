    ...
    echo '<div class="row">';
      echo '<div class="col-xs-12 col-sm-8 col-sm-push-2 col-md-8 col-md-push-2 col-lg-8 col-lg-push-2 footer-content">';
        echo '<div class="icons">';
          echo '<a class="icon" href="#"><i class="fa fa-envelope-o" aria-hidden="true"></i></a>';
          echo '<a class="icon" href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>';
          echo '<a class="icon" href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>';
          echo '<a class="icon" href="#"><i class="fa fa-google-plus" aria-hidden="true"></i></a>';
          echo '<a class="icon" href="https://www.youtube.com/watch?v=Tz1EYi9JV5I"><i class="fa fa-youtube" aria-hidden="true"></i></a>';
          echo '<a class="icon" href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a>';
        echo '</div>';
